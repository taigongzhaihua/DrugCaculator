...
namespace DrugCaculator.View.Components
{
    ...
    {
        // 依赖属性定义
        public static readonly DependencyProperty MessageProperty = DependencyProperty.Register(nameof(Message), typeof(string), typeof(CustomMessageBox), new PropertyMetadata(string.Empty));
        public static readonly DependencyProperty OkButtonTextProperty = DependencyProperty.Register(nameof(OkButtonText), typeof(string), typeof(CustomMessageBox), new PropertyMetadata("确定"));
        public static readonly DependencyProperty CancelButtonTextProperty = DependencyProperty.Register(nameof(CancelButtonText), typeof(string), typeof(CustomMessageBox), new PropertyMetadata("取消"));
        public static readonly DependencyProperty NoButtonTextProperty = DependencyProperty.Register(nameof(NoButtonText), typeof(string), typeof(CustomMessageBox), new PropertyMetadata("否"));
        public static readonly DependencyProperty IconFontProperty = DependencyProperty.Register(nameof(IconFont), typeof(string), typeof(CustomMessageBox), new PropertyMetadata(null));
        ...
        public string NoButtonText { get => (string)GetValue(NoButtonTextProperty); set => SetValue(NoButtonTextProperty, value); }
        public string IconFont { get => (string)GetValue(IconFontProperty); set => SetValue(IconFontProperty, value); }
        ...
        private void InitializeTemplate()
        {
            ...
            {
                var cancelButton = new Button { Content = CancelButtonText, Width = 60, Margin = new Thickness(10, 10, 10, 30) };
        ...
        public static MessageBoxResult Show(string message, string title) =>
            Show(message, title, MsgBoxButtons.OkCancel);
        ...
        public static MessageBoxResult Show(string message, string title, MsgBoxButtons buttons) =>
            Show(message, title, buttons, MsgBoxIcon.None);
        ...
        public static MessageBoxResult Show(string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon) =>
            Show(message, title, buttons, icon, MessageBoxResult.None);

        // 5. Show(string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon, MessageBoxResult defaultResult)
        public static MessageBoxResult Show(string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon, MessageBoxResult defaultResult)
        {
        ...
        public static MessageBoxResult Show(Window owner, string message, string title) =>
            Show(owner, message, title, MsgBoxButtons.OkCancel);
        ...
        public static MessageBoxResult Show(Window owner, string message, string title, MsgBoxButtons buttons) =>
            Show(owner, message, title, buttons, MsgBoxIcon.None);

        // 9. Show(Window owner, string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon)
        public static MessageBoxResult Show(Window owner, string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon) =>
            Show(owner, message, title, buttons, icon, MessageBoxResult.None);

        // 10. Show(Window owner, string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon, MessageBoxResult defaultResult)
        public static MessageBoxResult Show(Window owner, string message, string title, MsgBoxButtons buttons, MsgBoxIcon icon, MessageBoxResult defaultResult)
        {
            var messageBox = new CustomMessageBox
            {
                Message = message,
